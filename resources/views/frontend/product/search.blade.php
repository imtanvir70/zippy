...
<div class="container-fluid px-3 px-md-4 px-xl-5 py-4">
    <nav class="small text-secondary mb-3" aria-label="breadcrumb">
        ...
        <span class="text-dark fw-bold">অনুসন্ধান</span>
    </nav>
            ...
            <div>
                <div class="d-flex align-items-center gap-2 mb-2">
                    <span class="badge bg-dark rounded-pill px-3 py-1">
                        <i class="fa-solid fa-magnifying-glass me-1"></i> সার্চ রেজাল্ট
                    </span>
                    <span class="badge bg-light text-dark border rounded-pill px-3 py-1 catalog-total-count">
                        মোট {{ $products->total() }} টি পণ্য
                    </span>
                </div>
                <h1 class="h3 fw-bold text-dark font-heading mb-1">"{{ $searchTerm }}" - এর ফলাফল</h1>
                <p class="text-secondary small mb-0">আপনার সার্চকৃত শব্দের সাথে মিলে যাওয়া পণ্যসমূহ</p>
            </div>
