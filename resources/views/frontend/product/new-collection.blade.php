...
@section('title', 'নতুন কালেকশন ও লেটেস্ট গ্যাজেট কালেকশন | ' . ($settings['store_name'] ?? 'ZippyBD'))
@section('meta_description', 'লেটেস্ট প্রযুক্তি ও নতুন লঞ্চ হওয়া প্রিমিয়াম টেক গ্যাজেটসমূহ কিনুন ' . ($settings['store_name'] ?? 'ZippyBD') . ' থেকে সাশ্রয়ী মূল্যে।')
...
<div class="container-fluid px-3 px-md-4 px-xl-5 py-4">
    <nav class="small text-secondary mb-3" aria-label="breadcrumb">
        ...
        <span class="text-dark fw-bold">নতুন কালেকশন</span>
    </nav>
            ...
            <div>
                <div class="d-flex align-items-center gap-2 mb-2">
                    <span class="badge bg-primary rounded-pill px-3 py-1">
                        <i class="fa-solid fa-sparkles me-1"></i> নিউ অ্যারাইভালস
                    </span>
                    <span class="badge bg-light text-dark border rounded-pill px-3 py-1 catalog-total-count">
                        মোট {{ $products->total() }} টি পণ্য
                    </span>
                </div>
                <h1 class="h3 fw-bold text-dark font-heading mb-1">নতুন কালেকশন</h1>
                <p class="text-secondary small mb-0">লেটেস্ট প্রযুক্তি ও নতুন লঞ্চ হওয়া প্রিমিয়াম গ্যাজেটসমূহ</p>
            </div>
